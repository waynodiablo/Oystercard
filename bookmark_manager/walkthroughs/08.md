...
**Tests should always run against an empty database.** We should set up any required Test data in the test itself.
...
Now, in our test for listing links, we need to add some links to the database:
