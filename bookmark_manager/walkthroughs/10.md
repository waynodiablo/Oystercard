...
> If you prefer to work from a git diff, there is one [here](https://github.com/sjmog/bookmark_manager/commit/910f80060a7d2979129a3c525966de15737ac74c).
...
When we run `rspec`, our Rake task is automatically invoked. We can now delete the `spec/test_database_setup.rb` script!
