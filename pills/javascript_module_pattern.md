...
To explore this code, let's try and use the exclaim function.  (Normally, you would not a module inside the module itself, but we'll do that just for explanatory purposes.)
